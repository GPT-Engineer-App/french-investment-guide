      ...
      <Container maxW="container.lg" py={8}>
        ...
        <Box>
          <Box mb={8}>
            ...
            <Image src="https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwyfHxzdG9jayUyMG1hcmtldHxlbnwwfHx8fDE2ODAxMzc4NTB8MA&ixlib=rb-4.0.3&q=80&w=1080" alt="Stock market graph" my={8} />
            ...
            <Image src="https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwzfHxzdG9jayUyMG1hcmtldHxlbnwwfHx8fDE2ODAxMzc4NTB8MA&ixlib=rb-4.0.3&q=80&w=1080" alt="Stock market trading" my={8} />
            ...
            <Image src="https://images.unsplash.com/photo-1669951853441-e5d5ae004eb1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjAwOTd8MHwxfHNlYXJjaHw1fHxzdG9jayUyMG1hcmtldHxlbnwwfHx8fDE2ODAxMzgwMzZ8MA&ixlib=rb-4.0.3&q=80&w=1080" alt="Stock market trading" my={6} />
